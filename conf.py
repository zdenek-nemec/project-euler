...
sys.path.append('./problems_0xx/pep004_largest_palindrome_product')
sys.path.append('./problems_0xx/pep005_smallest_multiple')
sys.path.append('./problems_0xx/pep006_sum_square_difference')
sys.path.append('./problems_0xx/pep007_10001st_prime')
sys.path.append('./problems_0xx/pep008_largest_product_in_a_series')
sys.path.append('./problems_0xx/pep009_special_pythagorean_triplet')
